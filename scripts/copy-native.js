...
function getPlatformInfo() {
  ...
  const platformMap = {
    'linux': {
      'x64': { name: 'linux-x64', lib: 'libgpui_renderer.so', target: 'x86_64-unknown-linux-gnu' }
    },
    'darwin': {
      'x64': { name: 'darwin-x64', lib: 'libgpui_renderer.dylib', target: 'x86_64-apple-darwin' },
      'arm64': { name: 'darwin-arm64', lib: 'libgpui_renderer.dylib', target: 'aarch64-apple-darwin' }
    },
    'win32': {
