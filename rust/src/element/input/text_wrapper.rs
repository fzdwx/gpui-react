...
impl LineItem {
    ...
    pub fn new(len: usize, wrapped_lines: Vec<Range<usize>>) -> Self {
        Self { len, wrapped_lines }
    }
    ...
    pub fn lines_len(&self) -> usize {
        self.wrapped_lines.len().max(1)
    }

    /// Get the height of this line item given line height.
    pub fn height(&self, line_height: Pixels) -> Pixels {
