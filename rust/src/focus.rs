...
impl WindowFocusState {
    ...
    /// Set focus to an element. Returns (previous_focused, new_focused) for event dispatch.
...
/// Set focus to an element. Returns (blur_element_id, focus_element_id) for event dispatch.
