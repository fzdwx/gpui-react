...
impl HoverState {
    ...
    pub fn is_hovered(&self, element_id: u64) -> bool {
        self.hovered_elements.contains(&element_id)
    }
    ...
    /// Mark an element as not hovered. Returns true if it was previously hovered (leave).
